...
interface BusService {
    ...
    fun insertBus(
            ...
            @Field("nombre") nombre: String,
            @Field("apellido") apellido: String,
            @Field("rut") rut: String): Single<BusServer>
...
interface PassengerService {
    ...
    fun insertPassenger(
            ...
            @Field("nombre") nombre: String,
            @Field("apellido") apellido: String,
            @Field("rut") rut: String): Single<PassengerServer>
...
interface HorarioService {
    ...
    fun insertHorario(
            ...
            @Field("nombre") nombre: String,
            @Field("apellido") apellido: String,
            @Field("rut") rut: String): Single<HorarioServer>
...
interface RouteService {
    ...
    fun insertRoute(
            ...
            @Field("nombre") nombre: String,
            @Field("apellido") apellido: String,
            @Field("rut") rut: String): Single<RouteServer>
...
interface SitService {
    ...
    fun insertSit(
            ...
            @Field("nombre") nombre: String,
            @Field("apellido") apellido: String,
            @Field("rut") rut: String): Single<SitServer>
