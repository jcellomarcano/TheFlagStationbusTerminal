...
object ApiConstants {
    ...
    const val KEY_RUT = "rut"
    const val KEY_START = "ida"
    const val KEY_END = "vuelta"
    const val KEY_TERMINAL = "terminal"
    const val KEY_PATENTE = "patente"
    const val KEY_MARCA = "marca"
    const val KEY_CHOFER_ID = "id_chofer"
    const val KEY_NUM_ASIENTO = "num_asiento"
    const val KEY_ID_BUS = "id_bus"
    const val KEY_ID_PASAJERO = "id_pasajero"
